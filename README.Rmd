...
[![Travis-CI Build Status](https://travis-ci.org/davidski/emoncmsr.svg?branch=master)](https://travis-ci.org/davidski/emoncmsr)
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/davidski/emoncmsr?branch=master&svg=true)](https://ci.appveyor.com/project/davidski/emoncmsr)
...
```{r posting_to_inputs, eval=FALSE}
...
```{r creating_the_coffee_feed, eval=FALSE}
...
the bulk data inteface to several days of simulated data in a single call. 
